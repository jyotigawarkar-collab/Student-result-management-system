...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "a2rv8gs7OduD4IynlI4gK8jQdAvWL0mTnrXo460r3S80mZHvV6rj52wrkAjRsCee";
        </script>
...
<li class="visible-xs"><a href="/login/?next=/login/" class="login_link"
  ...
  <form class="form" action="" method="post"><input type="hidden" name="csrfmiddlewaretoken" value="a2rv8gs7OduD4IynlI4gK8jQdAvWL0mTnrXo460r3S80mZHvV6rj52wrkAjRsCee">
    <table>
